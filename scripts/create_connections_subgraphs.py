...
embedding_path = os.path.join(base_dir, "compgcn_node_embeddings_dim512.npy")
# output_path = os.path.join(base_dir, "dimension_subgraphs_connections_only_dim64_ort5.pkl")
output_path = os.path.join(base_dir, "dimension_subgraphs_connections_only_dim512.pkl")
